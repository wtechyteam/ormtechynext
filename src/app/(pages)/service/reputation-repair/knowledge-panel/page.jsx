  ...
  return (
    <>
     <head>
      ...
      <section className="sectionPadding bg_gray">
        <ImageInfoWrap
          title={"Strategic Approach to Knowledge Panel Optimization  "}
          ...
          darkButton="dark_btn"
          description={
            "<p>Knowledge panel optimization is something we at ORM Techies do methodically and strategically. We start by auditing your internet presence. We do this to find holes or areas for improvement. Next, we ensure the information we have about your brand is accurate and thorough. It must also fit your company's beliefs and aims.  </p><p>This includes adding professional photos and logos. It also involves checking contact info and updating business descriptions. To build trust, we also work hard to find and show positive comments and testimonies. To help search engines understand your site, we use schema markup and structured data.  </p><p>We must keep the Knowledge Panel up to date. Our staff constantly monitors it and makes the necessary updates. We are proficient. We can ensure that your Knowledge Panel represents your company well. It will attract the right readers. </p>"
          }
        />
      </section>
      <section className="sectionPadding bg_white">
      ...
      <section className="sectionPadding bg_gray">
        <ImageInfoWrap
          title={"Transforming Client Success through Knowledge Panels "}
          imageUrl={"/images/NA_SEP._25-removebg-preview.png"}
          showPrimeBtn={true}
          ...
          darkButton="dark_btn"
          description={
            "<p>Our companies used our Knowledge Panel optimization services. They saw big gains in their web visibility and customer interaction. Clients gain credibility and trust from their audience. They do this by providing accurate and appealing information. </p><p>More website traffic and better conversion rates are the outcomes. They come from higher visibility in search results for their brands. Also, positive evaluations and testimonials help build a base of loyal clients. They portray the company favorably. </p><p>The digital market is always changing. Our clients profit from our ongoing support and updates. These things ensure that their knowledge panels stay effective and relevant. Businesses may focus on their main skills. We will handle their online reputation when they work with ORM Techies.</p>"
          }
        />
      </section>
      <section className="sectionPadding bg_white">
        <ImageInfoWrap
          ...
          darkButton="dark_btn"
          description={
            "<p>At ORM Techies, we strive for perfection in everything we do. We are committed to surpassing our clients' expectations. We offer excellent Knowledge Panel management services.  </p><p>To get the best results, our staff stays up to date on the newest trends in SEO and digital marketing. We take great pride in our close attention to detail. We ensure that each item we select and update is reliable and important.  </p><p>We use a client-centric approach. We customize our tactics to fit your unique business requirements. We offer individualized, outcome-driven services. You may be sure that ORM Techies has the expertise to handle the internet reputation of your brand. </p>"
          }
        />
      </section>
      <LegalFaq />
